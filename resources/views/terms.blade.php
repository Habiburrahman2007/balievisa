    ...
    <div class="max-w-[760px] mx-auto px-6">
      ...
      <div class="flex flex-col gap-20">
        ...
        <div class="reveal">
          ...
          <div class="bg-white rounded-[2rem] p-10 border border-slate-200 shadow-sm space-y-5 text-center">
        ...
        <div class="reveal reveal-delay-1">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            @foreach(['i1', 'i2', 'i3'] as $idx)
              <div class="bg-white p-8 rounded-3xl border border-slate-200 hover:border-[var(--color-gold)] transition-all hover:shadow-lg hover:-translate-y-1 text-center">
                <div class="w-12 h-12 bg-slate-50 text-[var(--color-navy)] rounded-xl flex items-center justify-center mb-5 mx-auto">
        ...
        <div class="reveal reveal-delay-3">
          ...
          <div class="bg-white rounded-[2rem] p-10 border border-slate-200 shadow-sm space-y-6 text-center">
        ...
        <div class="reveal reveal-delay-4">
          ...
          <div class="bg-white rounded-[2rem] p-10 border border-red-100 shadow-sm text-center space-y-6">
        ...
        <div class="reveal reveal-delay-5">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-white p-8 rounded-[2rem] border border-slate-200 text-center">
        ...
        {{-- Section 7: Law --}}
        <div class="reveal reveal-delay-5">
          <div class="bg-[var(--color-navy)] rounded-[2.5rem] p-12 text-center shadow-2xl relative overflow-hidden">
            ...
            <div class="relative z-10">
              ...
              <p class="text-white/90 leading-relaxed max-w-[700px] mx-auto text-xl font-medium">{{ __('site.terms_sec7_d') }}</p>
            </div>
          </div>
        </div>
