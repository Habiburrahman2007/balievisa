  ...
  <section class="py-16 bg-[var(--color-bg)]">
    <div class="max-w-[1200px] mx-auto px-6">
            ...
            @foreach($cat['items'] as $num)
              <div data-faq class="bg-white border border-slate-200 rounded-xl overflow-hidden transition-all hover:border-[var(--color-navy)]/20">
                <button class="faq-q w-full flex items-center justify-between gap-4 px-6 py-4 text-left cursor-pointer group">
                  ...
                  <svg class="faq-chevron w-5 h-5 text-slate-400 flex-shrink-0 transition-transform duration-300" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
                </button>
      ...
      <div class="bg-gradient-to-r from-[var(--color-navy)] to-[var(--color-navy-light)] rounded-2xl p-8 text-center mt-6 reveal">
        ...
        <p class="text-white/65 text-[0.9rem] mb-6 max-w-[400px] mx-auto">{{ __('site.faq_cta_desc') }}</p>
